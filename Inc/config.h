...
#define N_MOT_MAX       70            // [rpm] Maximum motor speed limit
...
*/
  ...
  #define PRI_INPUT1            3, 0, 2047, 4095, 100     // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #define PRI_INPUT2            3, 0, 2047, 4095, 100      // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #ifdef DUAL_INPUTS
